			...
			editor.addButton('shortcodes', {
				...
				menu: [
						...
						menu: [
							{
								...
								onclick: function() {
									editor.windowManager.open({
										...
										onsubmit: function(e) {
											var e_data = e.data;
											editor.insertContent('[bullet column="' + e_data.column + '"][/bullet]')
										}
									})
								}
							},
						...
						menu: [
							{
								...
								onclick: function() {
									editor.windowManager.open({
										...
										onsubmit: function(e) {
											var e_data = e.data;
											editor.insertContent('[button open_in_new_tab="' + e_data.open_in_new_tab + '" link_url="' + e_data.link_url + '" link_text="' + e_data.link_text + '"][/button]');
										},
									});
								},
							},
					...
					// 		},
						...
						// 					name: 'popup_type',
						// 					values: [
						// 						{ text: 'Image Popup', value: 'image-popup' },
						// 						{ text: 'Iframe Popup', value: 'iframe-popup' },
						// 						{ text: 'Gallery Popup', value: 'gallery-popup' },
						// 					],
						// 				},
						// 				{
						// 					type: 'listbox',
						...
						// 					name: 'link_style',
						// 					values: [
						// 						{ text: 'Red Underline', value: 'red-underline' },
						...
						// 			onsubmit: function(e) {
						// 				var e_data = e.data;
						// 				editor.insertContent('[link link_style="' + e_data.link_style + '" popup_type="' + e_data.popup_type + '" open_in_new_tab="' + e_data.open_in_new_tab + '" link_url="' + e_data.link_url + '" link_text="' + e_data.link_text + '"][/link]');
						// 			},
						// 		});
						// 	},
						// },
